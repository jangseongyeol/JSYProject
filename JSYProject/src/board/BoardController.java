	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) 
		...
		//클라이언트에서 요청한 주소
				...
				if(url.indexOf("list.do")!=-1){
					...
					String page="/BSProject/board_list.jsp";
					...
					dao.insert(dto);
					String page="/BSProject/board_index.jsp";
...
//					BoardDTO dto=dao.view(num);
					...
					String page="/BSProject/board_view.jsp";
					RequestDispatcher rd=request.getRequestDispatcher(page);
					rd.forward(request, response);
					...
					//출력페이지 이동
					String page="/BSProject/board_comment_list.jsp";
					RequestDispatcher rd=request.getRequestDispatcher(page);
					rd.forward(request, response);
					...
					request.setAttribute("dto",dto);
					String page="/BSProject/board_reply.jsp";
					RequestDispatcher rd=request.getRequestDispatcher(page);
					rd.forward(request, response);
	...
	/*                    String page="/board_servlet/list.do";*/
					String page="/BSProject/board_search.jsp";
	/*					response.sendRedirect(contextPath+page);*/
						RequestDispatcher rd=request.getRequestDispatcher(page);
						rd.forward(request, response);
				}

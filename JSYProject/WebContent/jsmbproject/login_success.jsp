...
$(function(){
  $("#btnLogout").click(function(){
	  $.ajax({
			type: "post",
			url: "/JSYProject/storemember_servlet/logout.do",
			success: function(){
				location.replace("login.html");
			}
		});
...
<div data-role="page" id="page1">
  ...
  <!--    <div data-role="navbar" style="width: 98%;">
    ...
    <a href="#panel2" data-role="button" data-inline="true"  data-icon="search" data-iconpos="notext" data-inline="true" style="float: right; margin-right: 10px;">검색패널</a>     
     ...
     <br>
     <div id="page1_contentdiv2" >
       <div id="page1_contentdiv2_img" >
          <img src="../jsmbproject/image/mobile_main.jpg" style="width: 100%">
       </div>
       <div>
          <div id="page1_contentdiv2_img2">
            <img src="../jsmbproject/image/slide.jpg" style="width: 49.2%;">
            <img src="../jsmbproject/image/slide2.jpg" style="width: 49.2%;">
          </div>
          <div id="page1_contentdiv2_img3">
            <img src="../jsmbproject/image/slide3.jpg" style="width: 49.2%;">
            <img src="../jsmbproject/image/slide4.jpg" style="width: 49.2%;">
          </div>
       </div>
     </div>
     
     <div class="ui-grid-b" style="margin: 10px 10px;">  
     <div class="ui-block-a" style="text-align: center; font-size: 0.7rem;">
     <img src="../ModelImage/BestBaby/bestbaby.jpg" style="width: 98%; height: 90%;"><br>
     <strong>D크림가디건</strong><br>
     &#60;2color&#62;<br>
     *5~15*<br>
     51,200원  
     </div>
     <div class="ui-block-b" style="text-align: center; font-size: 0.7rem;">
     <img src="../ModelImage/BestBaby/bestbaby1.jpg" style="width: 98%; height: 90%;"><br>
     <strong>D울꽈배기가디건</strong><br>
     &#60;2color&#62;<br>
     *5~15*<br>
     54,400원
     </div>
     <div class="ui-block-c" style="text-align: center; font-size: 0.7rem;">
     <img src="../ModelImage/BestBaby/bestbaby2.jpg" style="width: 98%; height: 90%;"><br>
      <strong>오뜨베베수면조끼</strong><br>
     &#60;2color&#62;<br>
     *5~15*<br>
     14,400원
     </div>
     <div class="ui-block-a" style="text-align: center; font-size: 0.7rem;">
     <img src="../ModelImage/BestBaby/bestbaby3.jpg" style="width: 98%; height: 90%;"><br>
      <strong>뽀글이조끼</strong><br>
     &#60;2color&#62;<br>
     *5~15*<br>
     20,800원 
     </div>
     <div class="ui-block-b" style="text-align: center; font-size: 0.7rem;">
     <img src="../ModelImage/BestBaby/bestbaby4.jpg" style="width: 98%; height: 90%;"><br>
     <strong>KC무스탕점퍼</strong><br>
     &#60;2color&#62;<br>
     *5~15*<br>
     46,400원
     </div>
     <div class="ui-block-c" style="text-align: center; font-size: 0.7rem;">
     <img src="../ModelImage/BestBaby/bestbaby5.jpg" style="width: 98%; height: 90%;"><br>
     <strong>KC덤블점퍼</strong><br>
     &#60;2color&#62;<br>
     *5~15*<br>
     35,900원
     </div>

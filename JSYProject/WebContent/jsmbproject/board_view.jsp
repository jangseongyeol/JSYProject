...
function list(){
	$.ajax({
		type: "post",
		url: "${path}/board_servlet/listboard.do",
...
<body>
<div data-role="page" id="board_view_page">
...
<span ><b style="font-size: 1.5rem;">가입을 환영합니다</b><br>
<font style="font-size: 0.6rem;"> 고객님들께 항상 최선을 다하도록 노력하겠습니다.</font></span>
</div><br>

<div id="result" style="margin: 2% 2%;">
  
</div>


<div id="table_div" >
<table class="subtable" style="font-size: 1rem; text-align: center; margin:auto;">
   <tr>
   <td style="border: 1px solid silver; width: 10%;"><a href="#" style="text-decoration: none; color:black;">&#60;</a></td>
   <td style="border: 1px solid silver; width: 10%;"><a href="#" style="text-decoration: none; color:black;">1</a></td>
   <td style="border: 1px solid silver; width: 10%;"><a href="#" style="text-decoration: none; color:black;">2</a></td>
   <td style="border: 1px solid silver; width: 10%;"><a href="#" style="text-decoration: none; color:black;">3</a></td>
   <td style="border: 1px solid silver; width: 10%;"><a href="#" style="text-decoration: none; color:black;">4</a></td>
   <td style="border: 1px solid silver; width: 10%;"><a href="#" style="text-decoration: none; color:black;">5</a></td>
   <td style="border: 1px solid silver; width: 10%;"><a href="#" style="text-decoration: none; color:black;">&#62;</a></td>  
   </tr>
</table>
</div>

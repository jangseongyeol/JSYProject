...
function deleteBoard() {
	if(confirm("삭제하시겠습니까?")){
		document.edit_form.action="${path}/board_servlet/deleteboard.do";
...
function updateBoard() {
	...
	document.edit_form.action="${path}/board_servlet/updateboard.do";
	document.edit_form.submit();
}
</script> 
</head>
<body>
<div data-role="page" id="board_edit_page">
...
<div style="margin: 2% 2%;">
   <select id="board_option">
     <option value="2">가입인사(수정)</option>
   </select>
   <form name="edit_form" id="edit_form" method="post">
   <b>제목</b>
   <input name="title" id="title" value="${dto.title}">
   <b>아이디</b>
   <input name="userid" id="userid" value="${dto.userid}">
   <b>내용</b>
   <textarea rows="10" name="memo" id="memo">${dto.memo}</textarea>
   <div class="ui-grid-a">
   <div class="ui-block-a">
   <a data-role="button" data-mini="true" data-theme="b" onclick="updateBoard()" >수정</a>
   </div>
   <div class="ui-block-b">
   <a data-role="button" data-mini="true" data-theme="b" onclick="deleteBoard()">삭제</a>
   </div>

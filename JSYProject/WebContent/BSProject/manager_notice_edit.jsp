...
<meta name="viewport" content="width=device-width, initial-scale=1">
  ...
  function noticeDel() {
		...
		if (chk) {
			document.noticeEdit_form.action="${path}/notice_servlet/noticeDelete.do";
			document.noticeEdit_form.submit();
		}
	}
  function noticeUpdate() {
		var chk = confirm("수정하시겠습니까?");
		if (chk) {
			document.noticeEdit_form.action="${path}/notice_servlet/noticeUpdate.do";
			document.noticeEdit_form.submit();
		}
	}
  
  function noticeList() {		
		document.noticeEdit_form.action="${path}/BSProject/manager_notice_index.jsp";
		document.noticeEdit_form.submit();
	}
</script>
<style type="text/css">
  .noticeEdit_div .text_cotent {
     padding: 0 !important;
   }
   .noticeEdit_div .btn-primary {
...
<div class="container noticeEdit_div" id="noticeEdit_div">
            ...
            <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8 col-md-offset-2 col-sm-offset-2">
                <form method="post" name="noticeEdit_form" class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" id="managerid" name="managerid" value="${dto.managerid}">
                    </div>
                    <div class="form-group">
              ...
              <div class="form-group text-center">
                        ...
                        <button onclick="noticeUpdate()" class="btn btn-primary">
                            수정
                        </button>
                        <button onclick="noticeDel()" class="btn btn-warning">
                            삭제
                        </button>
                        <button type="submit" onclick="noticeList()" class="btn btn-dark pull-left">
                            목록
                        </button>
                    </div>

...
<div class="container joinDiv">
          ...
          <h2>회원가입</h2>
            ...
            <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8 col-md-offset-2 col-sm-offset-2">
                <form method="post" id="join_form" name="join_form" action="${path}/store_servlet/insertmember.do" class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" id="useremail" name="useremail" placeholder="이메일 주소를 입력해주세요">
                    </div>
                    <div class="labelname">
             ...
             <div class="form-group">
				<label for="inputEmailReceiveYn" class="col-lg-3 col-md-3 col-sm-4  control-label">이메일 수신여부</label>
				<div class="col-lg-9 col-md-9 col-sm-8 control-radio">
			...
			<div class="form-group">
				<label for="inputPhoneNumber" class="col-lg-3 col-md-3 col-sm-4 control-label">SMS 수신여부</label>
				<div class="col-lg-9 col-md-9 col-sm-8 control-radio">
					<label class="radio-inline">
             ...
             <div class="agree_form">
              <div class="agree_form1 col-xs-12 col-lg-6 col-md-6 col-sm-12">
...
STORE 서비스와 관련하여 궁금하신 사항이 있으시면 고객센터(대표번호: 1588 – 3820/ 평일 09:00~18:00)로 문의 주시기 바랍니다.
			...
			<div class="agree_form2 div col-xs-12 col-lg-6 col-md-6 col-sm-12">

...
$(function(){
	...
	$("#btnWrite").click(function(){
		location.href="${path}/BSProject/manager_reviewBoard_write.jsp";
	});
});
...
<div class="form-group search_div">
  <form class="" name="search_form" method="post"  action="${path}/managerreviewboard_servlet/reviewSearch.do">
  ...
  <div class="input-group input-group-lg col-xs-6 col-sm-6 col-lg-2 col-md-2 ">
   ...
   <c:forEach var="dto" items="${list}">
    ...
    <tr>
      ...
      <td><img src="../upload_image/${dto.filename}" style="width: 70px; height: 40px;"></td>
      <td>
        <!-- 답글 들여쓰기  -->
        <c:forEach var="i" begin="1" end="${dto.re_level}">
        &nbsp;&nbsp;
        </c:forEach>
      <a href="${path}/managerreviewboard_servlet/managerReviewView.do?num=${dto.num}">
        ${dto.subject}</a>
        <!-- 댓글갯수 표시  -->

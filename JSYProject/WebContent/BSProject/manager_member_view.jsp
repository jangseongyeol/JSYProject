...
<meta name="viewport" content="width=device-width, initial-scale=1">
  ...
  $(function(){
	  $("#btnList").click(function(){
			document.member_view_form.action="${path}/BSProject/manager_member_index.jsp";
...
<div class="container product_view_div">
            ...
            <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8 col-md-offset-2 col-sm-offset-2">
              ...
              <input type="hidden" name="usernum" value="${dto.usernum}">
                        ...
                        <button type="submit" onclick="memberDel()"  class="btn btn-warning">탈퇴
                        </button>

...
$(function(){
	$("#btnSave").click(function(){
		document.reviewWrite_form.action="${path}/managerreviewboard_servlet/reviewBoard_insert.do";
...
<div class="container write_div" id="write_div">
            ...
            <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8 col-md-offset-2 col-sm-offset-2">
                ...
                <select name="boardname" class="form-control">
                  <option value="REVIEW">REVIEW</option>
                    ...
                    <div class="form-group">
                        ...
                        <input type="userid" class="form-control" id="userid" name="userid" value="${dto.userid}"placeholder="아이디를 입력해주세요">
                    </div>
                    <div class="form-group">
              ...
              <div class="form-group text-center">
                        ...
                        <a type="submit" href="../BSProject/manager_reviewBoard_index.jsp" class="btn btn-warning">
                            취소<i class="fa fa-times spaceLeft"></i>
                        </a>
                        <a type="submit" id="btnList" href="../BSProject/manager_reviewBoard_index.jsp" class="btn btn-dark pull-left">

  ...
  <link rel="stylesheet" href="../BSProject/css/style.css">
   ...
   $(function(){
		...
		$("#btnList").click(function(){
			document.view_form.action="${path}/BSProject/board_index.jsp";
			document.view_form.submit();
		});
		$("#btnReply").click(function(){
			document.view_form.action="${path}/board_servlet/reply.do";
			document.view_form.submit();
		});
		$("#btnEdit").click(function(){
			document.view_form.action="${path}/board_servlet/pass_check.do";
			document.view_form.submit();
		});
	});

...
<meta name="viewport" content="width=device-width, initial-scale=1">
  ...
  function boardList() {		
		document.edit_form.action="${path}/BSProject/manager_board_index.jsp";
  ...
  function del() {
		...
		if (chk) {
			document.edit_form.action="${path}/managerboard_servlet/delete.do";
			document.edit_form.submit();
		}
	}
  function update() {
		...
		if (chk) {
			document.edit_form.action="${path}/managerboard_servlet/update.do";
			document.edit_form.submit();
		}
	}	
</script>

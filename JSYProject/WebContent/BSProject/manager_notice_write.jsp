...
$(function(){
	$("#btnSave").click(function(){
		document.notice_form.action="${path}/notice_servlet/insert_notice.do";
...
/* 	$("#btnList").click(function(){
 ...
 <style type="text/css">
   .noticewrite_div .text_cotent {
     padding: 0 !important;
   }
   .noticewrite_div .btn-dark {
    background-color: #333 !important;
    color: white !important;
   }
   .noticewrite_div .btn-primary {
    background-color: #333 !important;
    color: white !important;
...
<div class="container write_div" id="noticewrite_div">
            ...
            <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8 col-md-offset-2 col-sm-offset-2">
                <form method="post" name="notice_form" class="form-horizontal">
                ...
                <select name="boardname" class="form-control">
                  <option value="NOTICE" selected>NOTICE</option>
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" id="managerid" name="managerid" value="관리자"placeholder="아이디를 입력해주세요">
                    </div>
                    <div class="form-group">
              ...
              <div class="form-group text-center">
                        ...
                        <a type="submit" href="../BSProject/manager_notice_index.jsp" class="btn btn-warning">
                            취소
                        </a>
                        <a type="submit" id="btnList" href="../BSProject/manager_notice_index.jsp" class="btn btn-dark pull-left">
                            목록
                        </a>
                    </div>

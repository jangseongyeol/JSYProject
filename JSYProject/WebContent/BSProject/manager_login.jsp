...
<body>
 ...
 <div class="container login-form">
      <div class="row">
        ...
        <form accept-charset="UTF-8" role="form" id="login_form" name="managerLogin_form" method="post" action="${path}/storemanager_servlet/loginManager.do">    
            <div class="form-group">
                <label for="managerid">아이디</label>
                <input name="managerid" id="managerid" placeholder="ID" type="text" class="form-control" />
            </div>
            <div class="form-group">

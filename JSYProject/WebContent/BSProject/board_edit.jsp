...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.4.1/jquery.min.js"></script>
  ...
  function boardList() {		
		document.edit_form.action="${path}/BSProject/board_index.jsp";
  ...
  function del() {
		...
		if (chk) {
			document.edit_form.action="${path}/board_servlet/delete.do";
			document.edit_form.submit();
		}
	}
  function update() {
		...
		if (chk) {
			document.edit_form.action="${path}/board_servlet/update.do";
			document.edit_form.submit();
		}
	}	
...
<div class="container edit_div" id="edit_div">
            ...
            <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8 col-md-offset-2 col-sm-offset-2">
                <form method="post" name="edit_form" enctype="multipart/form-data" class="form-horizontal">
              ...
              <div class="form-group text-center">
                        ...
                        <button onclick="del()" class="btn btn-warning">
                            삭제
                        </button>
                        <button type="submit" onclick="boardList()" class="btn btn-dark pull-left">
                            목록
                        </button>
                    </div>

...
$(function(){
	$("#btnInsert").click(function(){
		location.href="${path}/BSProject/manager_notice_write.jsp";
	});
});
...
function notice_list(){
	...
	$.ajax({
		type: "post",
		url: "${path}/notice_servlet/noticeList.do",
		success: function(result){
			$("#noticeList_Board").html(result);
		}
	});
} 	
function noticeList(page){
	$.ajax({
		type: "post",
		url: "${path}/notice_servlet/noticeList.do?curPage="+page+"&search_option=${search_option}"+"&keyword=${keyword}",
		success: function(result){
			$("#noticeList_Board").html(result);
		}
	});
...
<div id="noticeList_Board" class="container fuild">

  ...
  <link rel="stylesheet" href="../BSProject/css/managerStyle.css">
   ...
   $(function(){
		...
		$("#btnList").click(function(){
			document.reviewView_form.action="${path}/BSProject/manager_reviewBoard_index.jsp";
			document.reviewView_form.submit();
		});
		$("#btnReply").click(function(){
			document.reviewView_form.action="${path}/managerreviewboard_servlet/reviewReply.do";
			document.reviewView_form.submit();
		});
		$("#btnEdit").click(function(){
			document.reviewView_form.action="${path}/managerreviewboard_servlet/reviewPass_check.do";
			document.reviewView_form.submit();
		});
	});
	...
	function comment_add(){
	 ...
	 $.ajax({
		 type:"post",
		 url:"${path}/managerreviewboard_servlet/reviewComment_add.do",
		 data:param,
		 success: function(){
			 $("#userid").val("");
			 $("#conents").val("");
	...
	function comment_list(){
		$.ajax({
			type:"post",
			url:"${path}/managerreviewboard_servlet/reviewCommentList.do",
			data:"num=${dto.num}",

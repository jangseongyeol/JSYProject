...
<meta name="viewport" content="width=device-width, initial-scale=1">
  ...
  $(function(){
		...
		$("#btnList").click(function(){
			document.reply_form.action="${path}/BSProject/manager_reviewBoard_index.jsp";
			document.reply_form.submit();
		});
...
<div class="container write_div">
            ...
            <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8 col-md-offset-2 col-sm-offset-2">
                <form method="post" name="reply_form" action="${path}/managerreviewboard_servlet/reviewInsertReply.do" class="form-horizontal">

...
//클릭한 페이지로 이동
  function list(page){
  	location.href="${path}/managerboard_servlet/search.do?curPage="+page+"&search_option=${search_option}"+"&keyword=${keyword}";
  }
  $(function(){
		...
		$("#btnWrite").click(function(){
			location.href="${path}/BSProject/manager_board_Write.jsp";
		});
	});
	</script>
	<style type="text/css">
...
<div class="container container_board" id="container_board">
 <div class="row text-center">
   ...
   <div class="form-group search_div">
     <form class="" name="search_form" method="post" action="${path}/managerboard_servlet/search.do">
  ...
  <table class="table table-hover text-center">
   ...
   <c:forEach var="dto" items="${list}">
    ...
    <tr>
      ...
      <a href="${path}/managerboard_servlet/view.do?num=${dto.num}">
        ${dto.subject}</a>
        <!-- 댓글갯수 표시  -->

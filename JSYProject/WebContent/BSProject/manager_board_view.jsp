  ...
  <script type="text/javascript">
   $(function(){
		...
		$("#btnList").click(function(){
			document.view_form.action="${path}/BSProject/manager_board_index.jsp";
			document.view_form.submit();
		});
		$("#btnReply").click(function(){
			document.view_form.action="${path}/managerboard_servlet/reply.do";
			document.view_form.submit();
		});
		$("#btnEdit").click(function(){
			document.view_form.action="${path}/managerboard_servlet/pass_check.do";
			document.view_form.submit();
		});
	});
	...
	function comment_add(){
	 ...
	 $.ajax({
		 type:"post",
		 url:"${path}/managerboard_servlet/comment_add.do",
		 data:param,
		 success: function(){
			 $("#userid").val("");
			 $("#conents").val("");
	...
	function comment_list(){
		$.ajax({
			type:"post",
			url:"${path}/managerboard_servlet/commentList.do",
			data:"num=${dto.num}",
...
<div class="container view_div" id="view_div">
            ...
            <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8 col-md-offset-2 col-sm-offset-2">
                <form method="post" name="view_form" class="form-horizontal">

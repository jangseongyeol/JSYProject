...
function member_list(){
	...
	$.ajax({
		type: "post",
		url: "${path}/store_servlet/member_list.do",
		success: function(result){
			$("#memberList_Board").html(result);
		}
	});
} 	
function memberList(page){
	$.ajax({
		type: "post",
		url: "${path}/store_servlet/member_list.do?curPage="+page+"&search_option=${search_option}"+"&keyword=${keyword}",
		success: function(result){
			$("#memberList_Board").html(result);
		}
	});
...
<div id="memberList_Board" class="container fuild">

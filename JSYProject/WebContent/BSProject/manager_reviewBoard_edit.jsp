...
<meta name="viewport" content="width=device-width, initial-scale=1">
  ...
  function reviewBoardList() {		
		document.reviewEdit_form.action="${path}/BSProject/manager_reviewBoard_index.jsp";
  ...
  function reviewDel() {
		...
		if (chk) {
			document.reviewEdit_form.action="${path}/managerreviewboard_servlet/reviewDelete.do";
			document.reviewEdit_form.submit();
		}
	}
  function reviewUpdate() {
		...
		if (chk) {
			document.reviewEdit_form.action="${path}/managerreviewboard_servlet/reviewUpdate.do";
			document.reviewEdit_form.submit();
		}
	}	
  </script>

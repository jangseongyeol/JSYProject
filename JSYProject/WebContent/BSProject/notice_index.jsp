...
function notice(){
	...
	$.ajax({
		type: "post",
		url: "${path}/noticemain_servlet/noticeMain.do",
...
function noticeList(page){
	$.ajax({
		type: "post",
		url: "${path}/noticemain_servlet/noticeMain.do?curPage="+page+"&search_option=${search_option}"+"&keyword=${keyword}",
		success: function(result){
			$("#noticeList_Board").html(result);
		}
	});

...
$(function(){
	...
	$("#btnList").click(function(){
		document.view_form.action="${path}/board_servlet/list.do";
...
<div class="container write_div" id="reviewReplyDiv">
            ...
            <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8 col-md-offset-2 col-sm-offset-2">
                <form method="post" name="reply_form" action="${path}/reviewboard_servlet/reviewInsertReply.do" class="form-horizontal">
                    <div class="form-group">
                        <label for="username">제목</label>
                        <input type="text" class="form-control" id="subject" name="subject" value="Re: ${dto.subject}" >
                    </div>
                    <c:choose>
              ...
              <div class="form-group">
				<label for="content_label">내용</label><br>			
					<textarea class="form-control text_cotent" name="contents" id="contents" rows="10" cols="10">${dto.contents}
			        </textarea>
              </div>

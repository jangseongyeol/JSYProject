...
$(function(){
	$("#btnSave").click(function(){
		document.write_form.action="${path}/managerboard_servlet/insert_board.do";
...
<div class="container write_div" id="write_div">
            ...
            <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8 col-md-offset-2 col-sm-offset-2">
                <form method="post" name="write_form" enctype="multipart/form-data" class="form-horizontal">
                <div class="form-group">
                <select name="boardname" class="form-control">
                  <option value="FREE BOARD" selected>FREE BOARD</option>
                </select>
                </div>
                    <div class="form-group">

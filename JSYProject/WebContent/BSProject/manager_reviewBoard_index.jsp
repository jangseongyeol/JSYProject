...
function rvboardList(){
	...
	$.ajax({
		type: "post",
		url: "${path}/managerreviewboard_servlet/reviewList.do",
...
function reviewboardList(page){
	$.ajax({
		type: "post",
		url: "${path}/managerreviewboard_servlet/reviewList.do?curPage="+page+"&search_option=${search_option}"+"&keyword=${keyword}",
		success: function(result){
			$("#container_reviewBoard").html(result);
		}
	});
